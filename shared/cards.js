...
{id:'komi',art:'img/komi.png',speed:'sorcery',name:'komi',type:'support',subtype:['クリエイター','イラストレーター'],cost:1,abilities:['heal_all'],text:'味方全投稿キャラのダメージ全回復/LP300回復',flavor:'肉まん食べたい',copies:2},
...
{id:'douga_fukugen',speed:'instant',name:'動画復元',type:'support',subtype:['規約'],cost:5,abilities:['grave_play'],text:'割り込み/ゴミ箱から投稿キャラ1体無料投稿',copies:2},
{id:'impression_seigen',speed:'instant',name:'インプレッション制限',type:'support',subtype:['規約'],cost:7,abilities:['debuff_all_500'],text:'割り込み/全キャラ-500/-500',flavor:'そういえばしばらくおすすめ欄で見てないな…',copies:2},
