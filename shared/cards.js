...
{id:'sakamachi',art:'img/sakamachi.png',speed:'sorcery',name:'坂街透',type:'support',subtype:['クリエイター','イラストレーター'],cost:3,abilities:['search_illustrator'],text:'イラストレーター3枚→1枚手札,2枚墓地',copies:1},
...
{id:'azusa',name:'掃除屋 アズサ',type:'creature',subtype:['人間','暗殺者','ヒロイン'],cost:5,power:4,toughness:3,abilities:['activated_azusa'],text:'4+T:相手トップ墓地送り',heroine:true,copies:1},
...
{id:'kikaku_botsu',speed:'sorcery',name:'企画ボツ',type:'support',subtype:['規約'],cost:4,abilities:['destroy_target'],text:'クリーチャー1体破壊',copies:2},
...
{id:'seishun_kiben',art:'img/seishun_kiben.png',speed:'sorcery',name:'青春詭弁',type:'support',subtype:['クリエイター','ライター'],cost:5,abilities:['free_summon_hero'],text:'手札の主人公/ヒロインを無料召喚',copies:1},
...
{id:'99wari',speed:'sorcery',name:'99割間違いない',type:'support',subtype:['規約'],cost:9,abilities:['99wari'],text:'LP900支払い/相手全クリーチャー破壊+相手手札全捨て',copies:1},
