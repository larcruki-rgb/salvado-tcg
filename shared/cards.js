...
{id:'salvado_cat',art:'img/salvado_cat.png',speed:'sorcery',name:'サルベド猫',type:'support',subtype:['クリエイター','管理者'],cost:5,abilities:['search_creator'],text:'クリエイター3枚サーチ→2枚捨て',copies:0},
{id:'makkinii',art:'img/makkinii.png',speed:'instant',name:'まっきーに',type:'support',subtype:['クリエイター','ディレクター'],cost:5,abilities:['buff_all'],text:'クリエイター2枚捨てで無料/全体+300/+300',copies:0},
{id:'sakamachi',art:'img/sakamachi.png',speed:'sorcery',name:'坂街透',type:'support',subtype:['クリエイター','イラストレーター'],cost:3,abilities:['search_illustrator'],text:'イラストレーター3枚→1枚手札,2枚墓地',copies:0},
...
{id:'hikaru',art:'img/hikaru.png',speed:'sorcery',name:'ひかる',type:'support',subtype:['クリエイター','イラストレーター'],cost:2,abilities:['draw_tap'],text:'2枚ドロー→全タップ',copies:4},
{id:'oyuchi',art:'img/oyuchi.png',speed:'sorcery',name:'おゆち',type:'support',subtype:['クリエイター','イラストレーター'],cost:1,abilities:['draw_illustrator'],text:'1枚ドロー(イラストレーターなら+1)',copies:4},
{id:'nari',art:'img/nari.png',speed:'sorcery',name:'NARI',type:'support',subtype:['クリエイター','イラストレーター'],cost:2,abilities:['look_five'],text:'デッキ上5枚から1枚手札に',copies:3},
{id:'ai_tsubame',art:'img/ai_tsubame.png',speed:'sorcery',name:'愛つばめ',type:'support',subtype:['クリエイター','イラストレーター'],cost:3,abilities:['draw_give'],text:'3枚ドロー→相手が1枚選んで捨て',copies:3},
...
{id:'kyamakiri',art:'img/kyamakiri.png',name:'キャマキリ',type:'creature',subtype:['昆虫'],cost:1,power:1,toughness:1,abilities:['attack_power_buff'],text:'攻撃時+200/+0',copies:4},
...
{id:'seishun_kiben',art:'img/seishun_kiben.png',speed:'sorcery',name:'青春詭弁',type:'support',subtype:['クリエイター','ライター'],cost:5,abilities:['free_summon_hero'],text:'手札の主人公/ヒロインを無料召喚',copies:2},
