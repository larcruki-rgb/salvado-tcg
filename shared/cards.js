...
{id:'jk_a',name:'一般女子高生A',type:'creature',subtype:['人間','一般人'],cost:2,power:1,toughness:1,abilities:['create_token_jk'],text:'3マナ:攻撃100 HP100トークン生成',copies:2},
...
{id:'shueki_teishi',speed:'instant',name:'収益停止',type:'support',subtype:['規約'],cost:4,abilities:['tap_opp_mana'],text:'相手のマナゾーン全タップ',copies:0},
...
{id:'seitokaichou',name:'生徒会長ヒロイン',type:'creature',subtype:['人間','ヒロイン'],cost:2,power:1,toughness:1,abilities:['vigilance','etb_draw'],text:'油断しない/登場時:1枚ドロー',copies:2},
{id:'osananajimi',name:'幼馴染ヒロイン',type:'creature',subtype:['人間','ヒロイン'],cost:2,power:1,toughness:1,abilities:['etb_search_hero'],text:'登場時:主人公サーチ',copies:2},
{id:'onna_joushi',name:'女上司ヒロイン',type:'creature',subtype:['人間','ヒロイン'],cost:2,power:1,toughness:1,abilities:['vigilance','etb_peek_top'],text:'油断しない/登場時:デッキトップ確認→シャッフル可',copies:2},
{id:'shiko_touchou',speed:'sorcery',name:'思考盗聴された！',type:'support',subtype:['サポート'],cost:2,abilities:['peek_hand'],text:'相手の手札を見る',copies:2},
...
{id:'kanwa_kyuudai',speed:'instant',name:'閑話休題',type:'support',subtype:['サポート'],cost:5,abilities:['all_tap'],text:'割り込み/全クリーチャータップ',copies:2},
