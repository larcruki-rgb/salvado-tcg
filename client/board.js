...
(function(){
  ...
  var cur = null, loading = false, pollTimer = null, recruitPending = false, lastList = [];
  ...
  function renderList(data){
    ...
    data.posts.forEach(function(p){
      ...
      h += '<div class="board-post' + (p.topic === 'recruit' ? ' recruit' : '') + '" data-id="' + p.id + '">' +
        '<img class="board-av" src="img/nyanko/p' + (p.avatar || 1) + '.png" alt="">' +
        '<div class="board-main"><div class="board-head"><span class="board-name">' + esc(p.name) + '</span><span class="board-time">' + ago(p.createdAt) + '</span></div>' +
